...
class UploadScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Upload Audit')),
      body: const Center(child: Text('Upload Placeholder')),
    );
  }
}
...
class ReportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('Report for $auditId')),
    );
  }
}
...
final router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/audit', builder: (context, state) => const UploadScreen()),
    GoRoute(
      path: '/report/:auditId',
