...
class ForensicAuditScreen extends StatelessWidget {
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: (report.riskScore > 50 ? Colors.red : Colors.green).withOpacity(0.3),
                    blurRadius: 20,
  ...
  Widget _buildDiscrepancyCard(ForensicDiscrepancy discrepancy) {
    Color severityColor;
    if (discrepancy.severity == 'HIGH') severityColor = Colors.red;
    else if (discrepancy.severity == 'MEDIUM') severityColor = Colors.orange;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.fromBorderSide(BorderSide(color: severityColor.withOpacity(0.2))),
        boxShadow: [
          BoxShadow(
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('ORIGINAL', style: TextStyle(fontSize: 10, color: Colors.grey)),
              ...
              const Icon(Icons.arrow_forward, size: 16, color: Colors.grey),
               Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('CORRECTED', style: TextStyle(fontSize: 10, color: Colors.grey)),
                    const SizedBox(height: 4),
                     Text(
...
class CircularPercentIndicator extends StatelessWidget {
  ...
  const CircularPercentIndicator({super.key, required this.radius, required this.percent, required this.text, required this.color});
